...
def checkemailbulk():
    ...
    filename = filename2
    resultsfilename = "resultsfor" + filename2
    ...
    while emailcount < numberofemails:
        ...
        while test < len(tests):
            fileinforesults[emailcount] = fileinforesults[emailcount] and log(tests[test](fileinfo[emailcount].lower()))
            test += 1
    ...
    print(
        'Email Validation Finished. New file created (resultsfor' + filename2 + ') with results inside. Program ending.')
    t = 0
    x = 0
    y = 0
